...
class DeploymentOrchestrator:
    ...
    def parse_connection_info(
        ...
        try:
            ...
            # Extract SSH access info
            ssh_hostname = outputs.get("sshHostname", {}).get("value")
            ssh_username = outputs.get("sshUsername", {}).get("value")
            ssh_command = outputs.get("sshCommand", {}).get("value")
